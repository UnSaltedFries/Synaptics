...
const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        "v1.0.9.feat1": "Global Legal Internationalization (EN/FR Privacy & Terms)",
        "v1.0.9.feat2": "High-Performance Event-Delegated Custom Cursor (Zero Jitter)",
        "v1.0.9.feat3": "Streamlined Page Transitions (Lightweight AnimatePresence)",
        "v1.0.9.feat4": "Mobile/Desktop UI Alignment (About page & Nav spacing)",
        "v1.0.9.feat5": "Stability Patch (IntersectionObserver safety fallbacks)",

        "v1.0.8.title": "Deep Engine & Occlusion Culling",
        "v1.0.8.date": "April 22, 2026",
        "v1.0.8.desc": "Major performance framework update introducing smart rendering and cross-browser resource management.",
        "v1.0.8.feat1": "Global Occlusion Culling via upgraded ScrollReveal system",
        "v1.0.8.feat2": "Viewport-aware visibility toggling for high-density components",
        "v1.0.8.feat3": "Balanced GPU memory allocation (Chrome/Brave PC stabilization)",
        "v1.0.8.feat4": "Optimized paint cycles by surgical use of visibility: hidden",
        ...
        "about.pillars.title": "Our Foundations",
        "about.pillars.subtitle": "Three pillars that define our approach to AI.",
        "about.pillars.p1.title": "Technical Excellence",
        "about.pillars.p1.desc": "Our agents are trained on the world's most powerful LLMs, ensuring human-like understanding.",
        "about.pillars.p1.stat": "2M+",
        "about.pillars.p1.label": "Minutes generated",
        "about.pillars.p2.title": "Seamless Integration",
        "about.pillars.p2.desc": "We connect directly to your existing tools: CRM, Calendars, and Telephony systems.",
        "about.pillars.p2.stat": "50+",
        "about.pillars.p2.label": "Languages supported",
        "about.pillars.p3.title": "Strategic Support",
        "about.pillars.p3.desc": "A dedicated team to refine your scenarios and maximize your conversion rates.",
        "about.pillars.p3.stat": "50+",
        "about.pillars.p3.label": "Trusted Partners",
        "about.vision.text": "Redefining the boundary between human and machine.",
        ...
        // SEO Meta
        "seo.description.home": "Automate calls, emails, and documents with custom AI agents. Synaptics is a Paris-based AI agency building the future of business operations.",
        "seo.description.about": "Discover how Synaptics is redefining the boundary between human and machine through high-performance AI agents.",
        "seo.description.pricing": "Transparent pricing for AI automation. From small businesses to high-volume enterprise operations.",
        "seo.description.contact": "Get in touch with Synaptics to automate your business with intelligent AI agents.",
        "seo.description.blog": "Explore how real businesses are scaling their operations with Synaptics AI agents.",

        // Contact Form Labels (Sync)
        "contact.form.industry.medical": "Healthcare & Medical",
        "contact.form.industry.realestate": "Real Estate",
        "contact.form.industry.legal": "Legal",
        "contact.form.industry.restaurant": "Restaurant",
        "contact.form.industry.btp": "Construction / Trades",
        "contact.form.industry.accounting": "Accounting",
        ...
        "contact.title.line1": "Contact the",
        "contact.title.line2": "Team",
        "contact.desc": "Have a question or want to see Synaptics in action? Use the form or contact us directly.",
        "contact.useCase": "Use Cases",
        "contact.useCase.desc": "AI agents for calls, emails, documents, billing, and custom workflows.",
        "contact.onboarding": "Deployment",
        "contact.onboarding.desc": "Deployment occurs after development (duration depends on your project).",
        "contact.pricing": "Pricing",
        "contact.pricing.desc": "Fixed monthly plans based on features and volume. No hidden fees.",
        "contact.form.name": "Name",
        "contact.form.email": "Email",
        "contact.form.company": "Company Name",
        "contact.form.useCase": "Industry / Use Case",
        "contact.form.otherDetail.placeholder": "Please specify your industry...",
        "contact.form.tellMore": "Tell us about your needs",
        "contact.form.tellMore.placeholder": "How many calls do you receive? What problem do you want to solve?",
        "contact.form.budget": "Budget",
        "contact.form.budgetPlaceholder": "Select budget",
        "contact.form.timeline": "Timeline",
        "contact.form.timelinePlaceholder": "e.g. Urgent, 2 weeks",
    ...
    fr: {
        // SEO Meta
        "seo.description.home": "Automatisez vos appels, emails et documents avec des agents IA sur mesure. Synaptics, l'agence IA parisienne au service de votre croissance.",
        "seo.description.about": "Découvrez comment Synaptics redéfinit la frontière entre l'homme et la machine grâce à des agents IA haute performance.",
        "seo.description.pricing": "Tarification transparente pour l'automatisation IA. De la TPE à l'entreprise à fort volume.",
        "seo.description.contact": "Contactez Synaptics pour automatiser votre entreprise avec des agents IA intelligents.",
        "seo.description.blog": "Découvrez comment de vraies entreprises scalent leurs opérations avec les agents IA de Synaptics.",

        // Contact Form Labels (Sync)
        "contact.form.industry.medical": "Santé & Médical",
        "contact.form.industry.realestate": "Immobilier",
        "contact.form.industry.legal": "Juridique",
        "contact.form.industry.restaurant": "Restauration",
        "contact.form.industry.btp": "BTP / Artisanat",
        "contact.form.industry.accounting": "Comptabilité",
        "contact.form.industry.ecommerce": "E-commerce",
        "contact.form.industry.other": "Autre",

        "contact.form.budget.starter": "Moins de 1k€ / mois",
        ...
        "contact.form.otherDetail.placeholder": "Précisez votre secteur...",
        ...
        "v1.0.9.feat1": "Internationalisation Juridique Globale (Privacy & Terms EN/FR)",
        "v1.0.9.feat2": "Refonte du Curseur (Délégation d'évènements, Zéro Jitter)",
        "v1.0.9.feat3": "Simplification des Transitions (Framer Motion AnimatePresence)",
        "v1.0.9.feat4": "Ajustement UI (Remontée du contenu À Propos & Espacement Nav)",
        "v1.0.9.feat5": "Patch de Stabilité (Sécurité Fallback IntersectionObserver)",

        "v1.0.8.title": "Deep Engine & Occlusion Culling",
        "v1.0.8.date": "22 Avril 2026",
        "v1.0.8.desc": "Mise à jour majeure de l'architecture de performance introduisant le rendu intelligent et la gestion des ressources cross-browser.",
        "v1.0.8.feat1": "Système global d'Occlusion Culling via ScrollReveal optimisé",
        "v1.0.8.feat2": "Gestion de visibilité par Viewport pour les composants haute densité",
        "v1.0.8.feat3": "Allocation équilibrée de la mémoire GPU (Stabilisation Chrome/Brave PC)",
        "v1.0.8.feat4": "Optimisation des cycles de peinture par usage chirurgical de visibility: hidden",
        ...
        "about.pillars.title": "Nos Fondations",
        "about.pillars.subtitle": "Trois piliers qui définissent notre approche de l'IA.",
        "about.pillars.p1.title": "Excellence Technique",
        "about.pillars.p1.desc": "Nos agents sont entraînés sur les modèles les plus performants, garantissant une compréhension humaine.",
        "about.pillars.p1.stat": "2M+",
        "about.pillars.p1.label": "Minutes générées",
        "about.pillars.p2.title": "Intégration Transparente",
        "about.pillars.p2.desc": "Nous nous connectons directement à vos outils existants : CRM, Agendas et Téléphonie.",
        "about.pillars.p2.stat": "50+",
        "about.pillars.p2.label": "Langues supportées",
        "about.pillars.p3.title": "Support Stratégique",
        "about.pillars.p3.desc": "Une équipe dédiée pour affiner vos scénarios et maximiser vos taux de conversion.",
        "about.pillars.p3.stat": "50+",
        "about.pillars.p3.label": "Partenaires de confiance",
        "about.vision.text": "Redéfinir la frontière entre l'homme et la machine.",
