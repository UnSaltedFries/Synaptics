                ...
                <div className="px-5 pt-24 pb-10">
                    <AnimatePresence mode="wait">
                        {isSubmitted ? (
                            ...
                            >
                                <BlurText
                                    text={`${t("contact.title.line1")} ${t("contact.title.line2")}`}
                                    animateBy="words"
                                    delay={80}
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                                    ...
                                    <div>
                                        ...
                                        <AnimatePresence>
                                            {useCaseOpen && (
                                                ...
                                                >
                                                    <div className="mt-1.5 rounded-xl border border-white/[0.1] bg-[#111] overflow-hidden max-h-[250px] overflow-y-auto" data-lenis-prevent="true">
                                    ...
                                    <button
                                        ...
                                        className="relative overflow-hidden w-full py-3.5 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-base mt-1 disabled:opacity-50 group active:scale-[0.98] transition-transform"
                                    >
                                        {/* Shimmer Effect */}
                                        {!isSubmitting && (
